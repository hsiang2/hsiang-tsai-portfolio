    ...
    return (
        <div className={styles.about}>
            ...
            <p className={styles.bio}>
                ...
                &emsp; &emsp;進入數位系開啟了我學習程式的旅程。首先，在大一的必修課程裡，我透過學習 C/C++ 建立程式基礎。接著，從選修的前端工程設計課中，我學會利用 HTML、CSS、JavaScript 和 React 框架，與團隊合作開發網頁。在該課程專題中，我主要負責撰寫程式實現組員繪製的視覺稿。此經驗讓我首次體會到前端的樂趣，但也體認到自己所學僅是前端技術的冰山一角，因此我開始透過線上課程等資源主動學習更多前後端技術。除網頁外，我也曾在其他課堂專題中使用React Native 框架開發 App、自學 Unity 與同學合作開發 2D 平台遊戲，並利用課餘時間參加學校社團 iOS club學習 Swift 語言。<br/><br/>
